const ShowCase = () => {
  return (
    <div className="p-2 mx-auto py-5">
      <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-2 mx-2">
        <div className="bg-white border-2 border-blue-100 shadow-xl px-2 rounded-md my-2">
        ...
        <div className="bg-white border-2 px-2 shadow-xl border-blue-100 rounded-md my-2">
