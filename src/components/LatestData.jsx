...
const stories = [
  ...
  },
  {
    id: 5,
    img: group,
    title: 'Duhumurizanye trainings',
    descrption: "At Duhumurizanye, we're dedicated to empowerment through education. Our 'Duhumurizanye Training' program is your pathway to personal and professional growth. Join us as we provide comprehensive training that equips individuals with the skills, knowledge, and confidence needed to succeed. Unlock your potential and embark on a journey towards a brighter future with us.",
  },
  {
    id: 6,
    img: zigama,
    title: 'Zigama',
    descrption: "Duhumurizanye Save: It's more than just a word; it's a lifeline. At Duhumurizanye, we are committed to making a real difference in people's lives. 'Save' is our promise to provide support, assistance, and a helping hand when it's needed most. Join us in our mission to create a safer, more secure future for all.",
  },
];
