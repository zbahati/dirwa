...
const LatestNews = () => {
  return (
    <div className='p-5 mx-auto'>
      ...
      <div className="grid grid-col-1 gap-5 sm:grid-cols-2 sm:gap-3 md:grid-cols-3 lg:grid-cols-3">
        {stories.map((story) => (
          <Link key={story.id} to="" className="sm:min-h-72 px-2 shadow-md rounded-sm shadow-blue-200">
