  ...
  return (
    <div className='px-2 mx-auto mb-3'>
      <div className='w-full h-[400px] relative bg-gradient-to-br from-black/90 to-black/0 z-1'>
        ...
        <Link to="" className='text-md absolute top-[70%] mx-6 text-white font-bold cursor-pointer bg-blue-600 px-5 py-3 hover:translate-x-2 duration-100 hover:bg-blue-300 '>Read more</Link>
      </div>
    </div>
  );
}
